...
if __name__ == "__main__":
    ...
    args.savename = 'par_' + str(args.cls_par) + '_smooth_' + str(args.smooth)
    args.out_file = open(osp.join(args.output_dir, 'log_tar_' + args.savename + '.txt'), 'w')
    args.out_file.write(print_args(args)+'\n')
    args.out_file.flush()
    train_target(args)

# python uda_digit_no_h_freeze.py --dset m2u --gpu_id 0 --output ckps_digits_no_h_freeze_no_smooth --cls_par 0.0 --smooth 0.0
# python uda_digit_no_h_freeze.py --dset m2u --gpu_id 0 --output ckps_digits_no_h_freeze --cls_par 0.0